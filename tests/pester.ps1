...
Remove-Module SystemCenterOrchestrator -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\SystemCenterOrchestrator.psd1"
Import-Module "$PSScriptRoot\..\SystemCenterOrchestrator.psm1" -Force
